...
const KW = {
	...
	hack: 'warzone cheat',
	esp: 'Call of Duty: Warzone ESP',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'Call of Duty: Warzone Aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Warzone Cheats', undetected: 'indetectables', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'Contacta support@cheatsforwarzone.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Warzone Cheats', undetected: 'indétectables', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'Contactez support@cheatsforwarzone.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Warzone Cheats kaufen', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Warzone Cheats', undetected: 'indetectáveis', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'Contacte support@cheatsforwarzone.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Warzone Cheats', undetected: 'indetectable', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'Contatta support@cheatsforwarzone.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Warzone Cheats kopen', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Warzone Cheats satın al', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'Destek ve yasal sorular için support@cheatsforwarzone.com.',
	},
	ar: {
		buy: 'اشترِ Warzone Cheats', undetected: 'غير مكتشف', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Warzone Cheatsを購入', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'サポート・法務: support@cheatsforwarzone.com',
	},
	ko: {
		buy: 'Warzone Cheats 구매', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => '지원 및 법무: support@cheatsforwarzone.com',
	},
	zh: {
		buy: '购买 Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => '支持与法务：support@cheatsforwarzone.com',
	},
	hi: {
		buy: 'Warzone Cheats खरीदें', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'सहायता: support@cheatsforwarzone.com',
	},
	id: {
		buy: 'Beli Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Warzone Cheats', undetected: 'undetected', maps: 'maps, sites, and buy stations',
		...
		legal: () => 'support@cheatsforwarzone.com för support och juridik.',
	},
};
